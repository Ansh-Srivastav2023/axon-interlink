...
const LeftPanel = ({
     ...
     */
    const renderSearch = () => {
        // Guard against edges being undefined or null
        const safeEdges = edges || [];
                ...
                {moduleSearchResults.length > 0 && (
                    ...
                    >
                        {moduleSearchResults.map((node, idx) => {
                            if (!node || !node.data) return null; // Guard against malformed node data
                            ...
                            // Added structural checks (e && ...) to prevent crashes
