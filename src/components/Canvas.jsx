...
const Canvas = ( { nodes, edges, onNodeClick, onNodesChange, onEdgesChange, onConnect, onReconnect, onEdgeClick, onPaneClick, edgeTypes, nodeTypes, recordHistory, isValidConnection, ConnectionMode, t, s } ) => {
    return (
        <div style={s.canvas}>
            <ReactFlow 
            nodes={nodes} 
